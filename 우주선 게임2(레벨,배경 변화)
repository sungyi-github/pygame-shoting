...
while SB == 0:
    ...
    if kill == 100:
        level = 7   
        white = [110,130,180]#새벽 
        if l == 3:
            level_1 += 1
            l += 1 
    if kill == 130:
        level = 8
        white = [130,150,200]#새벽 
        if l == 4:
            level_1 += 1
            l += 1 
    if kill == 150:
    ...
    text_time = font.render("level : {}".format(level_1), True, (255,255,0))
    screen.blit(text_time, (10, 25))
...
while GO == 1:
    ...
    screen.blit(text, (165, round(size[1]/2-50)))
    pygame.display.flip()
pygame.quit()
